...
export type GoalDeliverable = {
  ...
  resolvedPath?: string;
  pathResolutionStatus?: "resolved" | "needs_confirmation" | "unresolved";
  documentId?: string;
  required: boolean;
...
export type AgentArtifact = { id:string;kind:"file"|"directory"|"document"|"browser_result";path?:string;documentId?:string;mimeType?:string;sha256?:string;createdByToolCallId?:string };
