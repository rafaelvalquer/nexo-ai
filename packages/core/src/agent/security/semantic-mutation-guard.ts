const MUTATION=/\b(apagu(?:e|ar)|delete|deletar|excluir|arquiv(?:e|ar)|archive|marque\s+como\s+(?:n[aã]o\s+)?lido|envie|enviar|send|crie|criar|create|salve|salvar|escreva|escrever|grave|gravar|gere|gerar|write|mova|mover|move|renome(?:ie|ar)|rename|edite|editar|update|atualize|cancele|cancelar|trash|lixeira|digite|clique)\b/i;
