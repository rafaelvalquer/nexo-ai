...
export class ModelRouter{
  constructor(private readonly config:ModelRouterConfig={fast:process.env.NEXO_MODEL_FAST,balanced:process.env.NEXO_MODEL_BALANCED,quality:process.env.NEXO_MODEL_QUALITY}){}
