...
function normalizeRisk(value:unknown):RiskLevel { if(value==="SAFE_WRITE")return"WRITE";if(value==="SENSITIVE")return"CRITICAL";return value==="WRITE"||value==="CRITICAL"?value:"READ"; }
