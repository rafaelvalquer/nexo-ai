...
export class AutomationActionExecutor {
  ...
  async execute(action: AutomationAction, context: AutomationExecutionContext,signal?:AbortSignal): Promise<AutomationActionExecution> {
...
function resolveMacroVariable(token:string,context:AutomationExecutionContext):string{
