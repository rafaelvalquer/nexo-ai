export type AutomationTriggerCatalogItem = { id:string;title:string;description:string;icon:string;category:"schedule"|"email"|"filesystem"|"calendar"|"system";requiredCapabilities:string[] };
export const AUTOMATION_TRIGGER_CATALOG: AutomationTriggerCatalogItem[] = [
