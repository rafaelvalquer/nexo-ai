...
export function Tools() {
  ...
  return <div className="toolsPage"><header><div><span className="automationEyebrow">CAPACIDADES LOCAIS</span><h1>Ferramentas</h1><p>Catálogo carregado do Core. O Assistente seleciona e executa cada ferramenta dentro das permissões configuradas.</p></div></header>
