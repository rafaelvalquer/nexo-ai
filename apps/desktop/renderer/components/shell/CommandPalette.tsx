...
import { registerModalLayer } from "../ui/focus-trap";
...
export function CommandPalette() {
  ...
  useEffect(()=>{if(!open||!paletteRef.current)return;const unregister=registerModalLayer(paletteRef.current,()=>setOpen(false));return()=>{unregister();};},[open]);
