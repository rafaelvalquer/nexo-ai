...
const manifests = ["package.json", "packages/shared/package.json", "packages/core/package.json", "packages/browser-agent/package.json", "apps/desktop/package.json"].map(file => path.join(root, file));
